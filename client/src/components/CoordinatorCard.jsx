  ...
  if (isMobile) {
    return (
      ...
      >
        ...
        {/* ROW 3 — TAG PILLS & SOCIAL MEDIA BUTTONS IN ONE LINE */}
        <div className="flex items-center justify-between gap-[6px] w-full">
          ...
          {/* Social Media Buttons aligned inline to the right */}
          {hasSocials && (
            <div className="flex items-center gap-1.5 flex-shrink-0" onClick={(e) => { e.preventDefault(); e.stopPropagation(); }}>
              {socials.linkedin && (
                <a
                  ...
                  className="w-8 h-8 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-all duration-300 shadow-sm"
                  aria-label="LinkedIn"
                >
              ...
              {socials.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-[#24292F] hover:bg-[#24292F] hover:text-white transition-all duration-300 shadow-sm"
                  aria-label="GitHub"
                >
              ...
              {socials.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-[#E1306C] hover:bg-[#E1306C] hover:text-white transition-all duration-300 shadow-sm"
