    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          ...
          >
            {/* ── Left Side: Poster Studio View (Sticky Fixed Top on Mobile) ── */}
            <div className="sticky top-0 z-30 w-full md:w-[55%] h-[35vh] min-h-[250px] sm:h-[320px] md:h-full bg-slate-950 flex flex-col p-3 sm:p-4 md:p-6 overflow-hidden flex-shrink-0 shadow-lg md:shadow-none">
