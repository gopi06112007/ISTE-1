...
import { DashboardTableSkeleton, EventCardSkeleton, DashboardBlogSkeleton, DashboardAlbumSkeleton, ActivityLogSkeleton } from '../../components/ui/SkeletonLoaders';
        ...
        <div className="space-y-5">
          <div className="bg-[#EEF1F5] p-4 rounded-clay-sm shadow-clay-inset border border-slate-200/10">
            ...
            <div className="grid grid-cols-2 gap-4 mt-2 text-xs font-bold text-slate-600">
              ...
              <div>
                <span className="text-slate-400 block uppercase tracking-wider text-[10px]">JNTU / Email</span>
                <span className="text-slate-800 font-mono font-extrabold">{resetCoord?.jntuNo || resetCoord?.email || 'N/A'}</span>
              </div>
            </div>
          </div>
